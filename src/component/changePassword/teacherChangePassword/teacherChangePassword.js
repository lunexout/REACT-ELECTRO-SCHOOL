    ...
    <>
      <div className="form__div">
        ...
        {nowPassword.length > 0 && (
          <i class="fas fa-eye sto" onClick={eyeOpenCondition}></i>
        )}
      </div>
      <div className="form__div">
        <input
        ...
        {newPassword.length > 0 && (
          <i class="fas fa-eye sto" onClick={secondEyeOpenCondition}></i>
        )}
      </div>
      <div className="form__div">
        <input
        ...
        {repeatNewPassword.length > 0 && (
          <i class="fas fa-eye sto" onClick={repeatNewPasswordCondition}></i>
        )}
      </div>
    </>
  );
