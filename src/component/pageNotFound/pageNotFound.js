    ...
    <>
      ...
      <div className="_top-xqml">
        <div>
          ...
          >
            <defs>
              <clipPath id="clip-Artboard_4">
                <rect width="133" height="133"></rect>
              </clipPath>
            </defs>
            <g
              id="Artboard_4"
          ...
          <p>
            <b className="b">404.</b>
            <ins className="ins">შეცდომა</ins>
          </p>
          <p className="Pqo">მოთხოვნილი მისამართი ვერ მოიძებნა სერვერზე</p>
          <ins className="ins sqp">შიგთავსი დაზიანებულია ან არ არსებობს</ins>
        </div>
